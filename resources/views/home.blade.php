...
<body class="bg-gray-950 text-white font-[instrument-sans] antialiased">
    ...
    <main class="max-w-7xl mx-auto py-12 px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <!-- Card 1 -->
            <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-amber-500/20 hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-center w-16 h-16 rounded-xl bg-amber-500/10 text-amber-400 mb-4 mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m4-8v8m5-8l2 2m0 0l-7 7-7-7" />
                    </svg>
                </div>
                ...
                <div class="text-center">
                    <a href="/admin/tb-tokos" class="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-4 py-2 rounded-full transition">
                        Kelola
                    </a>
                </div>
            </div>
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-amber-500/20 hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-center w-16 h-16 rounded-xl bg-amber-500/10 text-amber-400 mb-4 mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-2.21 0-4 1.79-4 4v5h8v-5c0-2.21-1.79-4-4-4z" />
                ...
                <p class="text-gray-400 text-center mb-4">Pantau jumlah dan jenis limbah yang dikumpulkan setiap periode.</p>
                <div class="text-center">
                    <a href="/admin/laporan" class="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-4 py-2 rounded-full transition">
                        Lihat Laporan
                    </a>
                </div>
            </div>
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-amber-500/20 hover:-translate-y-1 transition-all duration-300">
                ...
                <div class="text-center">
                    <a href="/admin/users" class="bg-amber-500 hover:bg-amber-600 text-black font-semibold px-4 py-2 rounded-full transition">
                        Kelola Akun
                    </a>
                </div>
            </div>
